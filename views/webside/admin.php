...
<body class="overlay-scrollbar">
	...
	<div class="navbar">
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<img src="public/assets/logopiz.png" alt="ATPro logo" class="logo logo-light">
		...
		<ul class="navbar-nav nav-right">
			<li class="nav-item mode">
				<a class="nav-link" href="#" onclick="switchTheme()">
					<i class='bx bxs-moon dark-icon'></i>
			...
			<li class="nav-item avt-wrapper">
				<div class="avt dropdown">
					<img src="public/assets/comment.jpg " alt="User image" class="dropdown-toggle" data-toggle="user-menu">
